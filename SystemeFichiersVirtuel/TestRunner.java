...
public class TestRunner {
    ...
    public static void testStep2() {
        ...
        System.out.println(Integer.toHexString(buffer[3]  & 0xFF));
        System.out.println(Integer.toHexString(buffer[4]  & 0xFF));
        System.out.println(Integer.toHexString(buffer[5]  & 0xFF));
        System.out.println(Integer.toHexString(buffer[6]  & 0xFF));
